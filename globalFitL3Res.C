...
string scalingForL2OrL3Fit = "None";//ApplyL3ResDontScaleDijets";// to recreate corrections from DP2018_028 change to "None" here (and only run globalFitL3Res.C in zll_gam mode [globalFitL3Res(0.0,epoch=="L4" ? 2.4 : 1.3, epoch,"gam_zll","PtBalMPF");]);
