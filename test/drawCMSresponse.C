...
void drawCMSresponse() {
  ...
  if (!_jec) {
    ...
    //const char *st = "Summer19UL17_RunE_V1_SimpleL1_DATA";
    //const char *sd = "../../JECDatabase/textFiles/Summer19UL18_RunA_V5_DATA";
    //const char *st = "Summer19UL18_RunA_V5_DATA";
    const char *sd = "../JERCProtoLab/Summer20UL/global_fit/";
    const char *st = "Summer19UL17_RunH_VX_DATA";
    const char *s;
  ...
  */
  ...
  c1->SaveAs("pdf/drawCMSresponse_2017H_AK4PFchs.pdf");
